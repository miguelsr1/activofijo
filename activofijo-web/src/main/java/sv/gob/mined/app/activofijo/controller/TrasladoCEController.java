...
@ManagedBean
@ViewScoped
public class TrasladoCEController implements Serializable {
 ...
 public List<VwBienes> getLstBienesTrasladar() {
    ...
    public void visualizarPnl() {
      ...
      public void nuevoTraslado() {
        ...
        JsfUtil.redireccionar("/app/mantenimientos/trasladoBienesCE.mined?faces-redirect=true");
    }
    public void ingresaTraslado() {
        JsfUtil.redireccionar("/app/mantenimientos/trasladoBienesCE.mined?faces-redirect=true&idTraslado="+idTraslado);
    }
}
