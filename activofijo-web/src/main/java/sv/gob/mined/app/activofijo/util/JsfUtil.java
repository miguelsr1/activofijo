...
public class JsfUtil {
    ...
    public static void mensajeInsertLote(Integer i) {
        msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "<big>Información</big>", "<big>Se almacenaron "+i+" bienes satisfactoriamente</big>");
        FacesContext.getCurrentInstance().addMessage(null, msg);
    }
